...
public class Rel_Clientes extends JDialog {
	...
	private String [] titulos = {"Codigo", "Nome", "CPF", "RG", "Data Nascimento", "Endereco", "CEP", "Email", "Data Cadastro", "Cliente Ouro" };
	private int linha;
	private int coluna;
	...
	public void setTamDadosclientes(){
		this.dados = new String[controle.getTamanhoCliente()][10];
	}
	
	public void setTable() {
		
		Iterator<Usuario> clientes = controle.getClientes();
		this.linha = 0;
		...
		while(clientes.hasNext()) {
			...
			dados[this.linha][this.coluna] = ouro; this.coluna++;
			this.linha++;
		}
	}
