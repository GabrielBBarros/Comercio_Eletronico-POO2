...
public class Rel_Fabricantes_Produtos_mais_Vendidos extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public Rel_Fabricantes_Produtos_mais_Vendidos() {
	...
	public void setTamDadosfabricantes(){
		Iterator<Fabricante> fabricantes = controle.topFabricantesVolume();
		int tamanho = 0;
		while(fabricantes.hasNext()) {
			tamanho ++;
			fabricantes.next();
		}
		this.dados = new String[tamanho][7];
	}
