...
public class Rel_Dez_mais_Vendidos extends JDialog {
	...
	public void setTamDadosproduto(){
		this.dados = new String[controle.getTamanhoProdutos()][8];
	}
	
public void setTable() {
		
		Iterator<Produto> produtos = controle.topProdutos();
		this.linha = 0;
